...
import type { GoogleOAuthCredentials as _GoogleOAuthCredentials, UserProfile as _UserProfile, UserRole as _UserRole, YouTubeChannelAuth as _YouTubeChannelAuth } from "./declarations/backend.did.d.ts";
...
function from_candid_opt_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_GoogleOAuthCredentials]): GoogleOAuthCredentials | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        googleOAuthCredentials: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.googleOAuthCredentials))
    };
}
