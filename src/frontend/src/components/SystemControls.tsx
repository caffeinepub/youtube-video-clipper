    ...
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs text-orange-300/70">
          These actions affect all users. Ensure a maintenance window is
          scheduled.
        </p>
      </div>
      ...
      <AlertDialog open={restartDialogOpen} onOpenChange={setRestartDialogOpen}>
        <AlertDialogContent className="bg-[#0B0E14] border-white/10">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-muted-foreground">
              This will reset message counters and temporarily interrupt
              service. Clip and user data will be preserved.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel className="border-white/10 text-white hover:bg-white/5">
      ...
      >
        <AlertDialogContent className="bg-[#0B0E14] border-white/10">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-muted-foreground">
              This will initiate a server shutdown sequence. The system will
              become unavailable until manually restarted.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel className="border-white/10 text-white hover:bg-white/5">
